...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes: SitemapRoute[] = [
    ...
    { path: '/mortgage-tools/rent-vs-buy', changeFrequency: 'weekly', priority: 0.8 },
    { path: '/mortgage-tools/dti-calculator', changeFrequency: 'weekly', priority: 0.8 },
    { path: '/mortgage-tools/arm-vs-fixed', changeFrequency: 'weekly', priority: 0.8 },
