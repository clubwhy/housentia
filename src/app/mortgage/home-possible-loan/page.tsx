...
const FAQ_ITEMS = [
  {
    question: 'What is a Home Possible loan?',
    answer:
  ...
  {
    question: 'Who qualifies for Home Possible?',
    answer:
  ...
  {
    question: 'How does Home Possible differ from standard conventional?',
    answer:
  ...
  {
    question: 'Is Home Possible the same as HomeReady?',
    answer:
  ...
  {
    question: 'Can I use gift funds for my Home Possible down payment?',
    answer:
  ...
  {
    question: 'Where does Home Possible appear on the Loan Estimate?',
    answer:
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 font-sans text-[17px] text-gray-800" style={{ fontFamily: 'Inter, sans-serif', lineHeight: 1.7 }}>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4">
            A <strong>Home Possible loan</strong> is a Freddie Mac program for low- to moderate-income borrowers. It offers a 3% down payment, reduced <Link href="/mortgage/what-is-pmi" className="text-primary hover:underline font-medium">private mortgage insurance (PMI)</Link>, and flexible funding options—including gifts, grants, and community second mortgages. If you qualify, it can lower your upfront cost and your <strong>mortgage payment</strong> compared to a standard conventional loan.
          </p>
          <p className="text-gray-700 mb-4">
            Home Possible is a conventional loan—it follows Freddie Mac guidelines. It is not FHA or VA. Your <strong>loan amount</strong>, <strong>interest rate</strong>, and <strong>closing costs</strong> are disclosed on the <strong>Loan Estimate</strong> you receive within 3 business days of application under TRID (TILA-RESPA Integrated Disclosure). See <Link href="/mortgage/homeready-loan" className="text-primary hover:underline font-medium">What Is a HomeReady Loan</Link>, <Link href="/mortgage/conventional-loan" className="text-primary hover:underline font-medium">What Is a Conventional Loan</Link>, and <Link href="/mortgage/fha-vs-conventional-loan" className="text-primary hover:underline font-medium">FHA vs Conventional Loan</Link>.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4">
            With a 3% down payment, you need less cash at closing than a standard 5% or 20% conventional loan. For a $300,000 home, 3% down is $9,000—versus $15,000 at 5% or $60,000 at 20%. Your <strong>loan amount</strong> would be $291,000. PMI is required because you are below 20% <Link href="/mortgage/what-is-ltv" className="text-primary hover:underline font-medium">LTV</Link>, but Home Possible offers reduced PMI rates compared to standard conventional loans. That can lower your <strong>mortgage payment</strong>.
          </p>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4">
            You apply with a lender that offers Home Possible. The lender will <strong>underwrite</strong> your application using Freddie Mac guidelines. They verify your income, assets, credit, and that you meet the income limit for your area. The property must be a primary residence. You complete homebuyer education—often online or in person—before or at closing. The lender provides a <strong>Loan Estimate</strong> within 3 business days showing your <strong>interest rate</strong>, <strong>mortgage payment</strong>, and <strong>closing costs</strong>.
          </p>
          <p className="text-gray-700 mb-4">
            Your down payment can come from your own funds, gifts from family, grants, or community seconds. Documentation is required. The TILA (Truth in Lending Act) and RESPA (Real Estate Settlement Procedures Act) require clear disclosure of all costs. Your <Link href="/mortgage/what-is-apr" className="text-primary hover:underline font-medium">APR</Link> on the Loan Estimate reflects the cost of credit. Compare Home Possible with <Link href="/mortgage/what-is-interest-rate" className="text-primary hover:underline font-medium">interest rate</Link> and <Link href="/mortgage/apr-vs-interest-rate" className="text-primary hover:underline font-medium">APR</Link> from other programs—FHA, standard conventional, HomeReady—to see what fits.
          </p>
          <p className="text-gray-700">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4">
            Jordan is buying a $280,000 home in an eligible area. Their household income is 75% of the area median—within the limit. They use Home Possible with 3% down ($8,400). Their <strong>loan amount</strong> is $271,600. They receive a $5,000 grant from a local housing program and use $3,400 from savings plus the grant for the down payment and some <strong>closing costs</strong>.
          </p>
          <p className="text-gray-700 mb-4">
            At 6.5% <strong>interest rate</strong>, their <strong>mortgage payment</strong> (principal and interest) is about $1,717. With reduced Home Possible PMI, they pay about $95 per month for PMI—compared to roughly $135 for a standard conventional loan at the same LTV. Total P&I plus PMI: about $1,812. They complete homebuyer education online before closing. The example is illustrative—actual rates, PMI, and eligibility vary by lender and location.
          </p>
          <p className="text-gray-700">
            If Jordan had used FHA instead, they might have paid 3.5% down with FHA MIP for the life of the loan. Home Possible offers a conventional path with PMI that can be removed at 80% LTV. Compare the full <strong>Loan Estimate</strong> to see the difference.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4">
            For first-time homebuyers, saving for a down payment is often the biggest hurdle. Home Possible reduces that hurdle to 3% with reduced PMI. If you qualify by income and location, it can be a lower-cost alternative to FHA—especially because PMI can be removed at 80% LTV, whereas FHA MIP often lasts for the life of the loan. Your <strong>mortgage payment</strong> may be lower with Home Possible than with FHA at the same <strong>loan amount</strong>.
          </p>
          <p className="text-gray-700 mb-4">
            Flexible funding helps. Gifts from family, grants from housing agencies, and community seconds can cover the down payment and <strong>closing costs</strong>. That can make homeownership possible with less personal savings. The homebuyer education requirement helps you understand the process—many buyers find it useful. Use the <strong>Loan Estimate</strong> to compare Home Possible with FHA, HomeReady, and standard conventional. Your <strong>interest rate</strong> and <strong>closing costs</strong> may vary by program.
          </p>
        </section>

        {/* Pros and Cons */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Pros and Cons of Home Possible</h2>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <li>Not all lenders offer Home Possible</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li><strong>Using the property as a second home or investment:</strong> Home Possible is for primary residence only.</li>
            <li><strong>Not comparing with HomeReady and FHA:</strong> Get <strong>Loan Estimates</strong> for multiple programs. Your <strong>interest rate</strong> and <strong>closing costs</strong> may differ.</li>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            <li>Freddie Mac – Home Possible Mortgage</li>
