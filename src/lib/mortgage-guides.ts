...
export const GUIDE_ARTICLES: GuideArticle[] = [
  ...
  },
  {
    ...
    category: 'basics',
    relatedSlugs: ['how-dti-calculated', 'how-dti-affects-mortgage-approval', 'closing-costs-explained', 'what-is-piti', 'what-is-apr', 'what-is-ltv', 'what-is-mortgage-points', 'what-is-pmi'],
  },
  {
    slug: 'what-is-ltv',
    title: 'What is LTV',
    ...
    category: 'basics',
    relatedSlugs: ['what-is-mortgage-equity', 'what-is-dti', '5000-plus-closing-costs-breakdown', 'what-is-pmi', 'what-is-mortgage-insurance', 'what-is-apr', 'what-is-mortgage-points'],
  },
  {
    ...
    category: 'basics',
    relatedSlugs: ['what-is-a-mortgage-payment', 'what-is-piti', 'principal-and-interest', 'what-is-amortization', 'what-is-interest-rate', 'what-is-loan-term', 'what-is-apr'],
    keywords: ['principal', 'mortgage principal', 'loan balance'],
  },
  {
    slug: 'principal-and-interest',
    title: 'Principal and Interest Explained',
    description: 'Learn how principal and interest work in a mortgage payment, how the split changes over time, and how P&I relates to PITI.',
    category: 'basics',
    relatedSlugs: ['what-is-mortgage-principal', 'what-is-piti', 'what-is-amortization', 'what-is-a-mortgage-payment', 'what-is-interest-rate'],
    keywords: ['principal and interest', 'P&I', 'principal interest'],
  },
  {
    slug: 'what-is-piti',
    title: 'What Is PITI',
    ...
    category: 'basics',
    relatedSlugs: ['what-is-a-mortgage-payment', 'what-is-mortgage-principal', 'principal-and-interest', 'what-is-interest-rate', 'what-is-escrow', 'what-is-dti'],
  ...
  // Mortgage Process
  {
    ...
    category: 'costs',
    relatedSlugs: ['first-time-buyer-closing-costs', 'hidden-closing-costs-most-buyers-miss', 'closing-costs-explained', '5000-plus-closing-costs-breakdown', 'how-much-are-closing-costs-2026', 'prepaid-costs-vs-closing-costs', 'who-pays-closing-costs', 'who-pays-closing-costs-home-purchase', 'how-to-reduce-closing-costs', 'how-to-reduce-closing-costs-legally', 'what-is-loan-estimate', 'what-is-closing-disclosure', 'what-is-escrow', 'what-is-mortgage-insurance', 'what-is-mortgage-points', 'what-is-apr', 'what-is-an-appraisal-fee', 'what-is-a-credit-report-fee', 'what-is-a-title-insurance-fee', 'what-is-a-recording-fee'],
  },
  {
    slug: 'what-is-escrow',
  ...
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['closing-disclosure-explained', 'closing-disclosure-line-by-line-guide', 'what-is-loan-estimate', 'what-is-closing-costs', 'how-much-are-closing-costs-2026', 'what-is-apr', 'what-is-rate-lock'],
  },
  {
  ...
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['what-is-loan-estimate', 'closing-disclosure-explained', 'closing-disclosure-line-by-line-guide', 'what-is-closing-costs', 'closing-costs-explained', 'first-time-buyer-closing-costs', 'hidden-closing-costs-most-buyers-miss', '5000-plus-closing-costs-breakdown', 'how-much-are-closing-costs-2026', 'what-is-apr'],
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['what-is-closing-disclosure', 'closing-disclosure-line-by-line-guide', 'loan-estimate-explained', 'mortgage-closing-process', 'what-is-closing-costs', 'closing-costs-explained', 'first-time-buyer-closing-costs', 'hidden-closing-costs-most-buyers-miss', '5000-plus-closing-costs-breakdown', 'how-much-are-closing-costs-2026'],
  },
  {
    slug: 'closing-disclosure-line-by-line-guide',
    title: 'Closing Disclosure Explained (Line-by-Line Guide)',
    description: 'Page-by-page walkthrough of the five-page Closing Disclosure: loan terms, costs A–H, cash to close, APR, and escrow.',
    category: 'process',
    relatedSlugs: ['closing-disclosure-explained', 'what-is-closing-disclosure', 'loan-estimate-explained', 'what-is-rate-lock', 'what-happens-at-closing', 'mortgage-closing-process'],
    keywords: ['closing disclosure', 'line by line', 'TRID'],
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['what-happens-after-closing', 'what-happens-at-closing', 'mortgage-funding-process', 'what-happens-after-mortgage-approval', 'what-is-a-mortgage-servicer', 'closing-disclosure-explained', 'closing-disclosure-line-by-line-guide', 'mortgage-application-process', 'what-is-closing-disclosure', 'what-is-closing-costs'],
  },
  {
  ...
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['mortgage-closing-process', 'mortgage-funding-process', 'what-is-closing-disclosure', 'closing-disclosure-line-by-line-guide'],
  },
  {
  ...
  // Home Buying
  {
    ...
    category: 'home-buying',
    relatedSlugs: ['first-time-buyer-closing-costs', 'steps-to-buy-a-house-with-a-mortgage', 'mortgage-pre-approval-vs-pre-qualification', 'fha-loan', 'what-is-dti', 'what-is-ltv', 'prequalify'],
  },
  {
  ...
  },
  {
    ...
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'closing-costs-explained', 'hidden-closing-costs-most-buyers-miss', '5000-plus-closing-costs-breakdown', 'how-much-are-closing-costs-2026', 'loan-estimate-explained', 'average-mortgage-closing-costs', 'who-pays-closing-costs'],
  },
  {
    ...
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'closing-costs-explained', 'how-much-are-closing-costs-2026', 'mortgage-closing-cost-breakdown', 'who-pays-closing-costs'],
  },
  {
    slug: 'how-much-are-closing-costs-2026',
    title: 'How Much Are Closing Costs in 2026?',
    description: 'Real dollar ranges (2–5% of loan), fee categories, example totals, and Loan Estimate vs Closing Disclosure.',
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'closing-costs-explained', '5000-plus-closing-costs-breakdown', 'average-mortgage-closing-costs', 'mortgage-closing-cost-breakdown', 'loan-estimate-explained', 'what-is-closing-disclosure', 'what-is-rate-lock'],
    keywords: ['closing costs', '2026', 'loan estimate'],
  },
  {
    slug: 'closing-costs-explained',
    title: 'Closing Costs Explained',
    description: 'What you will actually pay: fee categories, cash to close, Loan Estimate vs Closing Disclosure, and how to prepare.',
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'loan-estimate-explained', 'closing-disclosure-explained', 'what-is-dti', 'mortgage-closing-cost-breakdown', 'first-time-buyer-closing-costs', 'hidden-closing-costs-most-buyers-miss', '5000-plus-closing-costs-breakdown', 'how-much-are-closing-costs-2026'],
    keywords: ['closing costs explained'],
  },
  {
    slug: 'first-time-buyer-closing-costs',
    title: 'First-Time Buyer? Don’t Overpay Closing Costs',
    description: 'Closing costs for first-time buyers: typical ranges, fee buckets, and how TRID disclosures help you compare offers.',
    category: 'costs',
    relatedSlugs: ['first-time-home-buyer', 'what-is-closing-costs', 'closing-costs-explained', 'hidden-closing-costs-most-buyers-miss', 'loan-estimate-explained', 'closing-disclosure-explained', 'how-to-reduce-closing-costs'],
    keywords: ['first-time buyer', 'closing costs'],
  },
  {
    slug: 'hidden-closing-costs-most-buyers-miss',
    title: 'Hidden Closing Costs Most Buyers Miss',
    description: 'Prepaids, escrow cushion, per diem interest, HOA and transfer charges, and other lines buyers overlook on TRID disclosures.',
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'prepaid-costs-vs-closing-costs', 'closing-costs-explained', 'mortgage-closing-cost-breakdown', 'loan-estimate-explained', 'closing-disclosure-explained'],
    keywords: ['hidden closing costs', 'prepaid', 'escrow'],
  },
  {
    slug: '5000-plus-closing-costs-breakdown',
    title: '$5,000+ in Closing Costs? Here’s the Breakdown',
    description: 'Where several thousand in closing costs go: lender, title, prepaid, and government fees—with typical dollar ranges.',
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'closing-costs-explained', 'mortgage-closing-cost-breakdown', 'loan-estimate-explained', 'closing-disclosure-explained', 'what-is-ltv'],
    keywords: ['closing costs', '5000', 'cash to close'],
  },
  {
    ...
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'how-to-reduce-closing-costs', 'prepaid-costs-vs-closing-costs', 'who-pays-closing-costs-home-purchase', 'seller-paid-closing-costs-explained', 'mortgage-closing-cost-breakdown'],
  },
  {
    ...
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'hidden-closing-costs-most-buyers-miss', 'who-pays-closing-costs', 'how-to-reduce-closing-costs', 'what-is-escrow', 'what-is-loan-estimate', 'what-is-closing-disclosure'],
  },
  {
  ...
  {
    slug: 'how-to-reduce-closing-costs',
    title: 'How to Reduce Closing Costs (Legally & Safely)',
    description: 'Legal ways to reduce mortgage closing costs: lender credits, negotiation, shopping services. Educational guide for U.S. homebuyers.',
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'first-time-buyer-closing-costs', 'who-pays-closing-costs', 'prepaid-costs-vs-closing-costs', 'mortgage-lender-credits-explained', 'seller-paid-closing-costs-explained'],
  },
  {
    ...
    category: 'costs',
    relatedSlugs: ['what-is-closing-costs', 'how-to-reduce-closing-costs', 'mortgage-lender-credits-explained', 'seller-paid-closing-costs-explained', 'who-pays-closing-costs'],
  },
  {
  ...
  },
  {
    ...
    category: 'rates',
    relatedSlugs: ['what-is-apr', 'what-is-loan-estimate', 'what-is-closing-disclosure', 'closing-disclosure-line-by-line-guide', 'how-much-are-closing-costs-2026', 'what-is-mortgage-points'],
  },
  {
