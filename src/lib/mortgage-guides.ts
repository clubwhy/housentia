...
export const GUIDE_ARTICLES: GuideArticle[] = [
  ...
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['mortgage-approval-process', 'mortgage-application-process', 'what-lenders-look-at-mortgage-approval', 'how-dti-affects-mortgage-approval', 'how-income-verified-mortgage'],
  },
  {
  ...
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['what-happens-after-mortgage-approval', 'what-is-a-mortgage-servicer', 'closing-disclosure-explained', 'mortgage-application-process', 'what-is-closing-disclosure', 'what-is-closing-costs'],
  },
  {
    ...
    category: 'process',
    relatedSlugs: ['mortgage-underwriting-explained', 'what-happens-after-mortgage-approval', 'mortgage-closing-process', 'mortgage-application-process'],
